...
class _CarrotTextSelectionControlsToolbar extends State<CarrotTextSelectionControlsToolbar> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.handleCut != null) {
      /// todo(Bas): localize
      addToolbarButton("Knip", widget.handleCut!);
    }

    if (widget.handleCopy != null) {
      /// todo(Bas): localize
      addToolbarButton("Kopieer", widget.handleCopy!);
    }

    if (widget.handlePaste != null && _clipboardStatus.value == ClipboardStatus.pasteable) {
      /// todo(Bas): localize
      addToolbarButton("Plak", widget.handlePaste!);
    }

    if (widget.handleSelectAll != null) {
      /// todo(Bas): localize
      addToolbarButton("Selecteer alles", widget.handleSelectAll!);
    }
